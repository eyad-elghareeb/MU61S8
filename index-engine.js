...
(function () {
  ...
  _trackerStyle.textContent = '.dash-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.6);backdrop-filter:blur(4px);z-index:2000;display:none;align-items:center;justify-content:center;padding:1rem}.dash-overlay.open{display:flex}.dash-modal{background:var(--surface);border:1px solid var(--border);border-radius:16px;padding:2rem;max-width:800px;width:100%;max-height:90vh;overflow-y:auto;box-shadow:var(--shadow)}.dash-header{display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem}.dash-close-btn{background:none;border:none;font-size:1.5rem;cursor:pointer;color:var(--text-muted);transition:color 0.2s}.dash-close-btn:hover{color:var(--accent)}.dash-scope-bar{display:flex;gap:0.5rem;margin-bottom:1rem;flex-wrap:wrap}.dash-summary{display:flex;gap:1.5rem;margin-bottom:1rem;padding-bottom:1rem;border-bottom:1px solid var(--border)}.dash-stat{text-align:center}.ds-val{font-size:1.5rem;font-weight:700}.ds-val.red{color:#ef4444}.ds-val.blue{color:#3b82f6}.ds-val.green{color:#22c55e}.ds-lbl{font-size:0.75rem;color:var(--text-muted);text-transform:uppercase}.dash-body{display:flex;flex-direction:column;gap:1rem}.dash-footer{display:flex;gap:0.75rem;margin-top:1rem;padding-top:1rem;border-top:1px solid var(--border);flex-wrap:wrap}.btn-dash-action{padding:0.6rem 1rem;border-radius:8px;border:1px solid var(--border);background:var(--surface2);color:var(--text);font-weight:600;cursor:pointer;transition:all 0.2s}.btn-dash-action:hover{border-color:var(--accent)}.btn-dash-danger{background:#ef4444;border-color:#ef4444;color:#fff}.btn-dash-danger:hover{background:#dc2626}.btn-dash-close{margin-left:auto;padding:0.6rem 1.2rem;border-radius:8px;border:1px solid var(--border);background:var(--surface2);color:var(--text);font-weight:600;cursor:pointer;transition:all 0.2s}.dash-folder-title{font-family:"Playfair Display",serif;font-size:1.05rem;font-weight:700;color:var(--accent);padding:0.75rem 0 0.4rem;margin-bottom:0.25rem;border-bottom:1px solid var(--border);display:flex;align-items:center;gap:0.4rem;cursor:pointer;user-select:none}.dash-folder-title:hover{opacity:0.85}.dash-folder-toggle{font-size:0.9rem;transition:transform 0.2s ease;display:inline-block}.dash-folder-toggle.collapsed{transform:rotate(-90deg)}.dash-folder-content{transition:max-height 0.3s ease,opacity 0.25s ease;overflow:visible;max-height:none;opacity:1;padding-bottom:0.5rem;flex:1}.dash-folder-content.collapsed{max-height:0;opacity:0;overflow:hidden}.dash-folder-header{display:flex;align-items:center;justify-content:space-between;gap:0.5rem}.dash-folder-select{margin-left:auto;width:18px;height:18px;cursor:pointer;accent-color:var(--accent)}.dash-q-item{display:flex;align-items:center;gap:0.75rem;padding:0.75rem;border:1px solid var(--border);border-radius:10px;background:var(--surface2);transition:all 0.2s}.dash-q-item:hover{border-color:var(--accent);transform:translateX(3px)}.q-meta{display:flex;gap:0.5rem;font-size:0.75rem}.q-tag{padding:0.2rem 0.5rem;border-radius:6px;font-weight:600}.q-tag.wrong{background:#fee2e2;color:#dc2626}.q-tag.flagged{background:#dbeafe;color:#2563eb}';
  ...
  _modalStyle.textContent = '.modal-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.6);backdrop-filter:blur(4px);z-index:2100;display:none;align-items:center;justify-content:center;padding:1rem}.modal-overlay.open{display:flex}.modal{background:var(--surface);border:1px solid var(--border);border-radius:16px;padding:2rem;max-width:420px;width:100%;box-shadow:var(--shadow);animation:slideUp 0.25s ease}@keyframes slideUp{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}.modal h3{font-family:"Playfair Display",serif;font-size:1.3rem;margin-bottom:0.75rem}.modal p{color:var(--text-muted);font-size:0.9rem;line-height:1.6;margin-bottom:1.25rem}.modal-actions{display:flex;gap:0.75rem}.modal-actions .btn-cancel{flex:1;padding:0.75rem;border-radius:10px;background:var(--surface2);border:1.5px solid var(--border);color:var(--text);font-weight:600;cursor:pointer;transition:all 0.2s ease}.modal-actions .btn-cancel:hover{border-color:var(--accent)}.modal-actions .btn-confirm{flex:1;padding:0.75rem;border-radius:10px;background:var(--accent);border:none;color:#fff;font-weight:600;cursor:pointer;transition:all 0.2s ease}.modal-actions .btn-confirm:hover{opacity:0.9}.modal-actions .btn-confirm.danger{background:#ef4444}.modal-actions .btn-confirm.danger:hover{background:#dc2626}';
