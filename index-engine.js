...
(function () {
  ...
  _trackerStyle.textContent = '.dash-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.6);backdrop-filter:blur(4px);z-index:2000;display:none;align-items:center;justify-content:center;padding:1rem}.dash-overlay.open{display:flex}.dash-modal{background:var(--surface);border:1px solid var(--border);border-radius:16px;padding:1.5rem;max-width:750px;width:100%;max-height:90vh;overflow-y:auto;box-shadow:var(--shadow)}.dash-header{display:flex;align-items:center;justify-content:space-between;margin-bottom:0.75rem}.dash-close-btn{background:none;border:none;font-size:1.3rem;cursor:pointer;color:var(--text-muted);transition:color 0.2s;padding:0.2rem;line-height:1;border-radius:6px}.dash-close-btn:hover{color:var(--accent);background:var(--surface2)}.dash-scope-bar{display:flex;gap:0.4rem;margin-bottom:0.75rem;flex-wrap:wrap}.dash-scope-tab{padding:0.4rem 0.85rem;border-radius:8px;border:1px solid var(--border);background:var(--surface2);color:var(--text);font-weight:600;font-size:0.8rem;cursor:pointer;transition:all 0.2s}.dash-scope-tab:hover{border-color:var(--accent)}.dash-scope-tab.active{background:var(--accent);border-color:var(--accent);color:#fff}.dash-summary{display:flex;gap:1.2rem;margin-bottom:0.75rem;padding-bottom:0.75rem;border-bottom:1px solid var(--border)}.dash-stat{text-align:center}.ds-val{font-size:1.3rem;font-weight:700}.ds-val.red{color:#ef4444}.ds-val.blue{color:#3b82f6}.ds-val.green{color:#22c55e}.ds-lbl{font-size:0.7rem;color:var(--text-muted);text-transform:uppercase}.dash-body{display:flex;flex-direction:column;gap:0.75rem}.dash-footer{display:flex;gap:0.6rem;margin-top:0.75rem;padding-top:0.75rem;border-top:1px solid var(--border);flex-wrap:wrap}.btn-dash-action{padding:0.5rem 0.85rem;border-radius:8px;border:1px solid var(--border);background:var(--surface2);color:var(--text);font-weight:600;font-size:0.8rem;cursor:pointer;transition:all 0.2s}.btn-dash-action:hover{border-color:var(--accent)}.btn-dash-danger{background:#ef4444;border-color:#ef4444;color:#fff}.btn-dash-danger:hover{background:#dc2626}.btn-dash-close{margin-left:auto;padding:0.5rem 1rem;border-radius:8px;border:1px solid var(--border);background:var(--surface2);color:var(--text);font-weight:600;font-size:0.8rem;cursor:pointer;transition:all 0.2s}.dash-folder-title{font-family:"Playfair Display",serif;font-size:0.95rem;font-weight:700;color:var(--accent);padding:0.6rem 0 0.3rem;margin-bottom:0.2rem;border-bottom:1px solid var(--border);display:flex;align-items:center;gap:0.3rem;cursor:pointer;user-select:none}.dash-folder-title:hover{opacity:0.85}.dash-folder-toggle{font-size:0.8rem;transition:transform 0.2s ease;display:inline-block}.dash-folder-toggle.collapsed{transform:rotate(-90deg)}.dash-folder-content{transition:max-height 0.3s ease,opacity 0.25s ease;overflow:visible;max-height:none;opacity:1;padding-bottom:0.4rem;flex:1}.dash-folder-content.collapsed{max-height:0;opacity:0;overflow:hidden}.dash-folder-header{display:flex;align-items:center;justify-content:space-between;gap:0.4rem}.dash-folder-select{margin-left:auto;width:16px;height:16px;cursor:pointer;accent-color:var(--accent)}.dash-q-item{display:flex;align-items:center;gap:0.6rem;padding:0.6rem;border:1px solid var(--border);border-radius:8px;background:var(--surface2);transition:all 0.2s}.dash-q-item:hover{border-color:var(--accent);transform:translateX(2px)}.q-meta{display:flex;gap:0.4rem;font-size:0.7rem}.q-tag{padding:0.15rem 0.4rem;border-radius:5px;font-weight:600;font-size:0.65rem}.q-tag.wrong{background:#fee2e2;color:#dc2626}.q-tag.flagged{background:#dbeafe;color:#2563eb}';
