...
(function () {
  ...
  _trackerStyle.textContent = '.dash-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.6);backdrop-filter:blur(4px);z-index:2000;display:none;align-items:center;justify-content:center;padding:1rem}.dash-overlay.open{display:flex}.dash-modal{background:var(--surface);border:1px solid var(--border);border-radius:16px;padding:1rem;max-width:750px;width:100%;max-height:90vh;overflow-y:auto;box-shadow:var(--shadow)}.dash-header{display:flex;align-items:center;justify-content:space-between;margin-bottom:0.5rem;padding-bottom:0.5rem;border-bottom:1px solid var(--border)}.dash-close-btn{background:var(--accent);border:none;font-size:1.2rem;cursor:pointer;color:#fff;transition:all 0.2s;padding:0.3rem 0.5rem;line-height:1;border-radius:8px;font-weight:600}.dash-close-btn:hover{background:var(--accent);opacity:0.9;transform:scale(1.05)}.dash-scope-bar{display:flex;gap:0.3rem;margin-bottom:0.5rem;flex-wrap:wrap}.dash-scope-tab{padding:0.35rem 0.7rem;border-radius:8px;border:1px solid var(--border);background:var(--surface2);color:var(--text);font-weight:600;font-size:0.75rem;cursor:pointer;transition:all 0.2s}.dash-scope-tab:hover{border-color:var(--accent)}.dash-scope-tab.active{background:var(--accent);border-color:var(--accent);color:#fff}.dash-summary{display:flex;gap:1rem;margin-bottom:0.5rem;padding-bottom:0.5rem;border-bottom:1px solid var(--border)}.dash-stat{text-align:center}.ds-val{font-size:1.1rem;font-weight:700}.ds-val.red{color:#ef4444}.ds-val.blue{color:#3b82f6}.ds-val.green{color:#22c55e}.ds-lbl{font-size:0.65rem;color:var(--text-muted);text-transform:uppercase}.dash-body{display:flex;flex-direction:column;gap:0.5rem}.dash-footer{display:flex;gap:0.5rem;margin-top:0.5rem;padding-top:0.5rem;border-top:1px solid var(--border);flex-wrap:wrap}.btn-dash-action{padding:0.45rem 0.75rem;border-radius:8px;border:1px solid var(--border);background:var(--surface2);color:var(--text);font-weight:600;font-size:0.75rem;cursor:pointer;transition:all 0.2s}.btn-dash-action:hover{border-color:var(--accent)}.btn-dash-danger{background:#ef4444;border-color:#ef4444;color:#fff}.btn-dash-danger:hover{background:#dc2626}.btn-dash-close{margin-left:auto;padding:0.45rem 0.85rem;border-radius:8px;border:1px solid var(--border);background:var(--surface2);color:var(--text);font-weight:600;font-size:0.75rem;cursor:pointer;transition:all 0.2s}.dash-folder-title{font-family:"Playfair Display",serif;font-size:0.9rem;font-weight:700;color:var(--accent);padding:0.5rem 0 0.25rem;margin-bottom:0.15rem;border-bottom:1px solid var(--border);display:flex;align-items:center;gap:0.3rem;cursor:pointer;user-select:none}.dash-folder-title:hover{opacity:0.85}.dash-folder-toggle{font-size:0.75rem;transition:transform 0.2s ease;display:inline-block}.dash-folder-toggle.collapsed{transform:rotate(-90deg)}.dash-folder-content{transition:max-height 0.3s ease,opacity 0.25s ease;overflow:visible;max-height:none;opacity:1;padding-bottom:0.3rem;flex:1}.dash-folder-content.collapsed{max-height:0;opacity:0;overflow:hidden}.dash-folder-header{display:flex;align-items:center;justify-content:space-between;gap:0.3rem}.dash-folder-select{margin-left:auto;width:15px;height:15px;cursor:pointer;accent-color:var(--accent)}.dash-q-item{display:flex;align-items:center;gap:0.5rem;padding:0.5rem;border:1px solid var(--border);border-radius:8px;background:var(--surface2);transition:all 0.2s}.dash-q-item:hover{border-color:var(--accent);transform:translateX(2px)}.q-meta{display:flex;gap:0.35rem;font-size:0.65rem}.q-tag{padding:0.12rem 0.35rem;border-radius:5px;font-weight:600;font-size:0.6rem}.q-tag.wrong{background:#fee2e2;color:#dc2626}.q-tag.flagged{background:#dbeafe;color:#2563eb}';
  document.head.appendChild(_trackerStyle);
  
  /* ── Inject tracker dashboard HTML ─────────────────────────── */
  var _dashEl = document.createElement('div');
  _dashEl.id = 'tracker-dashboard';
  _dashEl.className = 'dash-overlay';
  _dashEl.innerHTML = '<div class="dash-modal"><div class="dash-header"><h2 id="dash-title-text" style="font-family:\\"Playfair Display\\",serif;font-size:1.1rem;margin:0;">📊 Question Tracker</h2><button class="dash-close-btn" onclick="closeTrackerDashboard()">✕</button></div><div class="dash-scope-bar" id="dash-scope-bar"></div><div class="dash-summary"><div class="dash-stat"><div class="ds-val red" id="dash-total-wrong">0</div><div class="ds-lbl">Wrong</div></div><div class="dash-stat"><div class="ds-val blue" id="dash-total-flagged">0</div><div class="ds-lbl">Flagged</div></div><div class="dash-stat"><div class="ds-val green" id="dash-total-quizzes">0</div><div class="ds-lbl">Quizzes</div></div></div><div class="dash-body" id="dash-body"></div><div class="dash-footer"><button class="btn-dash-action" onclick="exportTrackerToPDF()" title="Export to PDF">📄 Export PDF</button><button class="btn-dash-action btn-dash-danger" onclick="confirmClearTrackerData()">🗑 Clear All</button><button class="btn-dash-close" onclick="closeTrackerDashboard()">Close</button></div></div>';
  document.body.appendChild(_dashEl);
  
  /* ── Inject modal overlay styles for confirmations ─────────── */
  var _modalStyle = document.createElement('style');
  _modalStyle.textContent = '.modal-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.6);backdrop-filter:blur(4px);z-index:2100;display:none;align-items:center;justify-content:center;padding:1rem}.modal-overlay.open{display:flex}.modal{background:var(--surface);border:1px solid var(--border);border-radius:16px;padding:1.5rem;max-width:400px;width:100%;box-shadow:var(--shadow);animation:slideUp 0.25s ease}.modal h3{font-family:"Playfair Display",serif;font-size:1.2rem;margin-bottom:0.5rem}.modal p{color:var(--text-muted);font-size:0.85rem;line-height:1.5;margin-bottom:1rem}.modal-actions{display:flex;gap:0.6rem}.modal-actions .btn-cancel{flex:1;padding:0.65rem;border-radius:8px;background:var(--surface2);border:1.5px solid var(--border);color:var(--text);font-weight:600;font-size:0.85rem;cursor:pointer;transition:all 0.2s}.modal-actions .btn-cancel:hover{border-color:var(--accent)}.modal-actions .btn-confirm{flex:1;padding:0.65rem;border-radius:8px;background:var(--accent);border:none;color:#fff;font-weight:600;font-size:0.85rem;cursor:pointer;transition:all 0.2s}.modal-actions .btn-confirm:hover{opacity:0.9}.modal-actions .btn-confirm.danger{background:#ef4444}.modal-actions .btn-confirm.danger:hover{background:#dc2626}@keyframes slideUp{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}';
  document.head.appendChild(_modalStyle);
  
  /* ── Inject modal HTML element ─────────────────────────────── */
  var _modalEl = document.createElement('div');
  _modalEl.id = 'clear-tracker-modal';
  _modalEl.className = 'modal-overlay';
  _modalEl.innerHTML = '<div class="modal"><h3>Clear Questions?</h3><p id="clear-tracker-message">Are you sure you want to clear all questions? This cannot be undone.</p><div class="modal-actions"><button class="btn-cancel" onclick="closeClearTrackerModal()">Go Back</button><button class="btn-confirm danger" onclick="clearAllTrackerData()">Clear Now</button></div></div>';
